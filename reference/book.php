...
<head>
  ...
  <title>Harverd Referencing Generator Tool | Harverd Referencing for Book.</title>
      ...
      <div  class="form">
        ...
        <td>
          <?php
            ...
            error_reporting(0);
            if (empty($_POST['authorName']) && empty($_POST['titleOfBook']) && empty($_POST['year']) 
              && empty($_POST['place']) && empty($_POST['lvisit'])) {
                ...
                echo "$authorName. ($yearOfPublication). <i>$titleOfBook</i>. $edition. $placeOfPublication: $publisher. $pageno";
        ...
        <br>
        <form action="book.php" method="post" id="contactform">
            <p class="contact"><label for="authprName">Author Name</label></p>
            ...
            <input name="yearOfPublication" placeholder="eg 2015">

            <p class="contact"><label for="placeOfPublication">Place of Publication</label></p>
            <input name="placeOfPublication" required="" type="text" placeholder="e.g. Kathmandu">

            <p class="contact"><label for="publisher">Publisher</label></p>
            <input name="publisher" type="text" required="">

            <p class="contact"><label for="website">Edition</label></p>
            <select name="edition">
            ...
            <p class="contact"><label for="pageno">Page No</label></p>
            <input type="text" name="pageno" required="" placeholder="e.g. p61-69">

            <input class="buttom" name="submit" value="Generate reference!" type="submit">
            <input class="buttom" name="submit" value="Reset" type="reset"> 	 
        </form> 
      </div>      
    </div>
